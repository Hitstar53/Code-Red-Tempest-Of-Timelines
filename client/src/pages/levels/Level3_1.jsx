...
function Level3_1() {
  const check = () => {
    document.querySelector('.answerTextbox').classList.remove('wrong')
    document.querySelector('.wrongAnswer').style.display = 'none'
    console.log(document.querySelector('.answerTextbox').value)
    var x = document.querySelector('.answerTextbox').value
    if (x.toUpperCase() != 'HTML') {
      document.querySelector('.answerTextbox').classList.add('wrong')
      document.querySelector('.wrongAnswer').style.display = 'inline'
    }
  }
      ...
      <div className={styles.container}>
        <div className={styles.innerContainer}>
          ...
          <input
            ...
            type="text"
          />
          <span className={styles.wrongAnswer}>Wrong answer. Retry</span>
