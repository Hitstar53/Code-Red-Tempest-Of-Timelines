...
const Prelevel3 = () => {
  const text = [
    ...
    "Hmm.. The code looks like some sort of language, and honestly at first, the characters look like random marks and scribbles.\nI am unable to decipher this, but remember, keep your head calm whenever in panic.....",
  ];
  return (
    <div>
