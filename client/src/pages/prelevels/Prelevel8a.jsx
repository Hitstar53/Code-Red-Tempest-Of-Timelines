...
const Prelevel8a = () => {
  const text = [
    "Good Choice, my agent… uniting him with his wife would have ended the two timelines. Well, moving on, now we are in the year 3170 CE. The final showdown happens here. ",
  ...
  return (
    <div>
      <Layout text={text} speed={90} lvl={'8_1'} />
    </div>
  );
};
