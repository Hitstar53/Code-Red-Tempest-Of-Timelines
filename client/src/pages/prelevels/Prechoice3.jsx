...
const Prechoice3 = () => {
  const text = [
    ...
    'North Korea was a bloody job, but yes, I killed the assassins there one by one ensuring there was no one who would kill Kim Jong Un in the first place.',
  ...
  return (
    <div>
      <Layout2 text={text} speed={70} lvl={'choice'} />
    </div>
  )
}
