...
const Prelevel4 = () => {
  const text = [
    ...
    "In the land of the rising sun, where swords dance in the breeze, lived a noble undefeated samurai, whose victories never ceased. One month and one day since his demise, On what day does his legend realize?",
