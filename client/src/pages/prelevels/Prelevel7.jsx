...
const Prelevel7 = () => {
  const text = [
    ...
    "Kim Jong Un has been tipped from his inner circle that he is going to be assassinated. That’s why he is on a covert security journey across different cities of North Korea. We need to download the report which contains all the destinations and assassinate him at the final destination. But Andwyn’s here already to prevent the assassination, so we have to move fast.",
  ];
  return (
    <div>
